# Autogenerated wrapper script for Deldir_jll for x86_64-apple-darwin14
export libdeldir
...
const libdeldir_splitpath = ["lib", "libdeldir.dylib"]
...
const libdeldir = "@rpath/libdeldir.dylib"
